...
#define DEVICE_DRIVER_RELEASE_VERSION   ("3.1.0.0")
 ...
 * Else, disable this compile option by default.
 * By default, this compile option is disabled.
 */
 ...
 * By default, this compile option is disabled.
 */
#define CONFIG_UPDATE_FIRMWARE_BY_SW_ID  //opened by yangnan for fw update
 ...
 * By default, this compile option is enabled.
 */
/*#define CONFIG_UPDATE_FIRMWARE_BY_TWO_DIMENSIONAL_ARRAY */  //closed by yangnan
 ...
 */
#define CONFIG_ENABLE_TOUCH_DRIVER_DEBUG_LOG (0)
...
#define DBG(fmt, arg...) do {\
	                           if (CONFIG_ENABLE_TOUCH_DRIVER_DEBUG_LOG == 1 || IS_TOUCH_DRIVER_DEBUG_LOG_ENABLED == 1)\
	                               printk(fmt, ##arg);\
                         } while (0)
