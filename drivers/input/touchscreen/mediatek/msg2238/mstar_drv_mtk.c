...
#include <mach/upmu_sw.h>   //alex 20151112
#include <mtk_thermal_typedefs.h>  //alex 20151112
//#include <mt-plat/mt_boot.h>
#include <mt_gpio.h>   

//#include <mt6580/include/mach/cust_eint.h>   //alex 20151112
...
extern void fih_tptest_sysfs_deinit(void);//add by yangnan for read rw version
...
{   
	...
	fih_tptest_sysfs_deinit();//add by yangnan for read fw version
    
    return TPD_OK;
}
static unsigned short force[] = { 0, (0x4C>>1), I2C_CLIENT_END, I2C_CLIENT_END };
...
{  
   printk("TPD init device driver (Built %s @ %s)\n", __DATE__, __TIME__);
/*
